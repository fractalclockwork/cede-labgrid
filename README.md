...
make -C lab/docker pico-build     # UF2 / ELF under lab/pico/hello_lab/build
...
3. RPi programs Pico  
4. RPi programs Uno — scripted from Dev-Host: **`make pi-gateway-flash-test-uno`** (**`PORT`** optional); **`pytest lab/tests/test_uno_gateway_env.py`** covers resolver/configuration offline (**[pico-uno-subtargets.md](lab/pi/docs/pico-uno-subtargets.md)**).

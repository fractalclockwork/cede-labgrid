...
def main() -> int:
    ...
    p.add_argument("port", help="e.g. /dev/ttyACM0 or /dev/serial/by-id/usb-Raspberry_Pi_…")
    p.add_argument(
        "--expect",
        default="CEDE hello_lab rp2 ok",
        help="substring that must appear from hello_lab firmware",
    )
